...
import { buildPpioFormSchema } from './legacy-formily.ts';
import {
  buildPpioEndpoint,
...
async function createPpioGptImageTask(
  ...
  const requestBody = buildPpioGptImageRequestBody(payload, prompt, images, mask, edit);
...
export function buildPpioGptImageRequestBody(
  payload: Record<string, any>,
  prompt: string,
  images: string[],
