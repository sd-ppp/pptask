...
paths:
  /api/v1/jobs/createTask:
    post:
      ...
      operationId: bytedance-seedance-2-mini
      tags:
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - Must be `bytedance/seedance-2-mini` for this endpoint
                  enum:
                ...
                input:
                  ...
                  properties:
                    ...
                    web_search:
                      type: boolean
                      description: >-
                        Use online search. (Web search only can be used in the
                        scene of t2v)
                    nsfw_checker:
                      type: boolean
                      description: >-
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-38321605-run
components:
  schemas:
    nsfw_checker:
      type: object
