    ...
    post:
      ...
      description: >-
        ...
        **Streaming Response Format:**
        ...
        - **Note**:This model does not support function calls and claude code.
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-37595083-run
components:
  schemas: {}
  securitySchemes:
    BearerAuth:
