...
paths:
  /codex/v1/responses:
    post:
      ...
      deprecated: false
      description: >-
        > GPT 5.6 Luna API is a multimodal chat-completions style endpoint that
        ...
        <CardGroup cols={2}>
          ...
          <Card title="Unified Endpoint" icon="💻">
            Uses the unified <code>/api/v1/responses</code> endpoint with <code>model</code> set to one of <code>gpt-5-6-luna</code>.
          </Card>
        </CardGroup>
      ...
      operationId: gpt-5-6-luna-completions
      tags:
          ...
          application/json:
            schema:
              ...
              properties:
                model:
                  type: string
                  description: 'Target model name. Allowed values: `gpt-5-6-luna`.'
                  enum:
                    - gpt-5-6-luna
                  x-apidog-enum:
                    - value: gpt-5-6-luna
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-39805470-run
components:
  schemas:
    ToolFunction:
      type: object
