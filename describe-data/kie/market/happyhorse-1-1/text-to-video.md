                ...
                input:
                  ...
                  properties:
                    prompt:
                      type: string
                      description: >-
                        Text description of the video to generate.  Supports any
        ...
        - BearerAuth1: []
          x-apidog:
            ...
            use:
              id: KVMyug0oFgQrmEBD6SUL6
            scopes:
              KVMyug0oFgQrmEBD6SUL6:
                undefined: []
      x-apidog-folder: docs/en/Market/Video Models/HappyHorse
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/1184766/apis/api-38309233-run
components:
  schemas:
    ApiResponse:
      type: object
